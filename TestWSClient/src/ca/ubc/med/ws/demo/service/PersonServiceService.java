 ...
 * 
 */
@WebServiceClient(name = "PersonServiceService", targetNamespace = "http://service.demo.ws.med.ubc.ca/", wsdlLocation = "http://fomvss269d4:8080/TestWSServer/person?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://fomvss269d4:8080/TestWSServer/person?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://fomvss269d4:8080/TestWSServer/person?wsdl', retrying as a local file");
