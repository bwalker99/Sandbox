  ...
  public static Connection getConnection(String dbName) {
    ...
    try {
      ...
      try { 
          ...
          System.out.println(new java.util.Date() + "  JNDI:Couldn't get connection Tomcat style connection.");
    	  ds = null;
         }
...
//        System.out.println("2 - DataSource connection timeout is: " + ds.getLoginTimeout());
        ...
        if (conn != null) {
          ...
          connected = true;
            ...
            System.out.println(new java.util.Date() + "  JNDI:Couldn't get connection");
      }
      else 
         System.out.println(new java.util.Date() + "  JNDI:Datasource is null. Couldn't get connection");
    }
    catch (Exception e) {
      System.out.println(new java.util.Date() + "  " + "JNDI:Exception:" + e.getMessage());
      e.printStackTrace();
    }
    return conn;
  }
